...
/* cvrin.c */ extern int read_pla (FILE *fp, int needs_dcset, int needs_offset, int pla_type, pPLA *PLA_return,int function_num);
...
/* cvrin.c */ extern void parse_pla (FILE *fp, pPLA PLA,int function_num);
/* cvrin.c */ extern void read_cube (register FILE *fp, pPLA PLA,int function_num);
